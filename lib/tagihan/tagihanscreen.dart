...
class _TagihanPageState extends State<TagihanPage> {
  ...
  final Map<String, String> statusEndpoints = {
    "Belum Dibayar":
        'https://hayami.id/apps/erp/api-android/api/daftar_tagihan.php?sts=1',
    "Dibayar Sebagian":
        'https://hayami.id/apps/erp/api-android/api/daftar_tagihan.php?sts=2',
    "Lunas": 'https://hayami.id/apps/erp/api-android/api/daftar_tagihan.php?sts=3',
    "Void": 'https://hayami.id/apps/erp/api-android/api/daftar_tagihan.php?sts=4',
