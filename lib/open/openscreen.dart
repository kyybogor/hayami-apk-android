  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      final openInvoices = data.where((item) {
        ...
        return resi == null || resi.toString().trim().isEmpty;
      }).toList();
      ...
      // Tambahkan filter otomatis berdasarkan bulan dan tahun saat ini
      filterByMonthYear();
    } else {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: const Text("Dispatched", style: TextStyle(color: Colors.blue)),
                            ...
                            return ListTile(
                              ...
                              onTap: () async {
                                final result = await Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        DetailPengirimanPage(invoice: invoice),
                                  ),
                                );
                                if (result == true) {
                                  fetchInvoices();
