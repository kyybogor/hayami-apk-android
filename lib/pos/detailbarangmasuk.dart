...
Future<void> fetchProduct() async {
  ...
  final url = Uri.parse("http://192.168.1.2/pos/masuk_detail.php?id_transaksi=$idTransaksi");
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonData['status'] == 'success') {
        ...
        final stockResponse = await http.get(Uri.parse('http://192.168.1.2/hayami/stock.php'));
  ...
  Future<void> handleApprove() async {
    ...
    final url = Uri.parse('http://192.168.1.2/pos/inbond.php?id_transaksi=$idTransaksi&id_cabang=$idCabang');
