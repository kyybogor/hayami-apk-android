...
class _OpnameState extends State<Opname> {
  ...
  Future<void> fetchSuggestions() async {
    final response =
        await http.get(Uri.parse('http://192.168.1.4/pos/stock.php'));
  ...
  void _tambahStok() async {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.1.4/pos/tambah_list_opname.php'),
      body: {
        'id_inv_in': idUser,
...
class OpnameListFromApiState extends State<OpnameListFromApi> {
  ...
  Future<void> _fetchOpnameList(String idUser) async {
    final url =
        Uri.parse('http://192.168.1.4/pos/opname_list.php?id_inv_in=$idUser');
  ...
  final url = Uri.parse('http://192.168.1.4/pos/delete_opname.php');
  try {
...
Future<void> _simpanDanOtorisasi() async {
  ...
  final url = Uri.parse('http://192.168.1.4/pos/opname.php');
